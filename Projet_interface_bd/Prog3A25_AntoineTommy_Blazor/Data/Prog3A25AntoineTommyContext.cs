...
public partial class Prog3A25AntoineTommyContext : DbContext
{
    public Prog3A25AntoineTommyContext()
    {
    }

    public Prog3A25AntoineTommyContext(DbContextOptions<Prog3A25AntoineTommyContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=dicjwin01.cegepjonquiere.ca;Initial Catalog=Prog3A25_AntoineTommy;MultipleActiveResultSets=true;User Id=prog3e04;Password=suite23");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Adresse>(entity =>
        {
            entity.HasKey(e => e.NoAdresse).HasName("PK__Adresse__C5F103242682660E");
        });

        modelBuilder.Entity<Donnee>(entity =>
        {
            entity.HasKey(e => e.NoDonnee).HasName("PK__Donnee__DC6E7FA1224AB02F");
        ...
        {
            entity.HasKey(e => e.NoPlante).HasName("PK__Plante__D6215A3588C496E9");
        ...
        {
            entity.HasKey(e => e.NoQuestion).HasName("PK__Question__ADD49C5067C53A27");
        ...
        {
            entity.HasKey(e => e.NoReponse).HasName("PK__Reponse__FBCF9BA898000692");
        ...
        {
            entity.HasKey(e => e.NoUtilisateur).HasName("PK__Utilisat__CB66E30B2836B3A4");
            ...
            entity.HasMany(d => d.NoQuestions).WithMany(p => p.NoUtilisateurs)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("NoUtilisateur", "NoQuestion").HasName("PK__LikesQue__D1BBAACEBA8927B6");
            ...
            entity.HasMany(d => d.NoReponses).WithMany(p => p.NoUtilisateurs)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("NoUtilisateur", "NoReponse").HasName("PK__LikesRep__54DA1AB1E94F86B4");
        ...
        {
            entity.HasKey(e => e.NoWiki).HasName("PK__Wiki__121F63F96E6D34CB");
        });
